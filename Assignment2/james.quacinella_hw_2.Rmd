...
Seems like there are 719 predictors that we can drop because they have near zero variance.
...
Thats a pretty awful looking chart but we do see significant number of predictors that are correlated. Lets remove them with threshold .75:
